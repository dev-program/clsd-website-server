...
// Retrieve all Tutorials from the database and include associated User and Role models
exports.findAll = (req, res) => {
  ...
  Tutorial.findAll({
    where: condition,
    include: [
      { model: User, attributes: ['username', 'email'], include: [{ model: Role, attributes: ['name'] }] }
    ]
  })
    .then(data => {
      res.send(data);
